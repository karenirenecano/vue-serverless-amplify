<template>
  <div v-bind:class="amplifyUI.formSection">
    ...
    <div v-bind:class="amplifyUI.sectionBody">
      ...
      <label for="" v-show="!fileReady">... Preparing file upload ...</label>
      <input
        ref="file_input"  
        type="file"
    ...
    <button v-show="fileReady" v-if="file" v-bind:class="[amplifyUI.photoPickerButton, amplifyUI.button]" 
          v-on:click="upload" :disabled="!file">{{ (loading) ? '... Uploading ...' : options.title}}</button>
